...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="scategoryList" title="类别表" actionUrl="scategoryController.do?datagrid" idField="id" fit="true">
   ...
   <t:dgToolBar title="编辑" icon="icon-edit" url="scategoryController.do?addorupdate" funname="update"></t:dgToolBar>
